...
private:
	...
	unique_ptr<LogicalOperator> BindCopyDatabaseSchema(Catalog &source_catalog, const std::string &to_database);
	unique_ptr<LogicalOperator> BindCopyDatabaseData(Catalog &source_catalog, const std::string &to_database);
