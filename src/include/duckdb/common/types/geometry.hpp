...
enum class GeometryStorageType : uint8_t {
	...
	POINT_XY = 0b00010001,
	LINESTRING_XY = 0b00010010,
	POLYGON_XY = 0b00010011,
	MULTIPOINT_XY = 0b00010100,
	MULTILINESTRING_XY = 0b00010101,
	MULTIPOLYGON_XY = 0b00010110,

	POINT_XYZ = 0b00100001,
	LINESTRING_XYZ = 0b00100010,
	POLYGON_XYZ = 0b00100011,
	MULTIPOINT_XYZ = 0b00100100,
	MULTILINESTRING_XYZ = 0b00100101,
	MULTIPOLYGON_XYZ = 0b00100110,

	POINT_XYM = 0b01000001,
	LINESTRING_XYM = 0b01000010,
	POLYGON_XYM = 0b001000011,
	MULTIPOINT_XYM = 0b01000100,
	MULTILINESTRING_XYM = 0b01000101,
	MULTIPOLYGON_XYM = 0b01000110,

	POINT_XYZM = 0b01100001,
	LINESTRING_XYZM = 0b01100010,
	POLYGON_XYZM = 0b01100011,
	MULTIPOINT_XYZM = 0b01100100,
	MULTILINESTRING_XYZM = 0b01100101,
	MULTIPOLYGON_XYZM = 0b01100110,
};
